...
async function getProducts(searchParams: {
  ...
  // Building the query based on the search params
    ...
    <>
      <main className="container mx-auto px-6 py-12 sm:px-8 lg:px-10">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <div className="w-full md:w-2/3 flex justify-center sm:justify-end">
            <ProductFilters
        ...
        {/* Showing pagination only if there iss more than one page */}
        {totalPages > 1 && (
